...
// Formatear los errores de validación para una respuesta más clara
...
// Función para validar una parte específica de la request (params, body o query)
...
// Middleware para validar params, body y query usando DTOs y class-validator
